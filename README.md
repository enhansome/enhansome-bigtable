...
* [Go](https://github.com/googleapis/google-cloud-go/tree/master/bigtable) ⭐ 4,503 | 🐛 426 | 🌐 Go | 📅 2026-09-02 - Official implementation of the Google Cloud Bigtable Go client.
* [C#](https://github.com/googleapis/google-cloud-dotnet) ⭐ 1,093 | 🐛 17 | 🌐 C# | 📅 2026-09-02 - Official implementation of the Google Cloud Bigtable .NET client.
* [C++](https://github.com/GoogleCloudPlatform/google-cloud-cpp/tree/master/google/cloud/bigtable) ⭐ 660 | 🐛 200 | 🌐 C++ | 📅 2026-09-02 - Official implementation of the Google Cloud Bigtable C++ client.
* [HBase Java](https://github.com/GoogleCloudPlatform/cloud-bigtable-client) ⭐ 184 | 🐛 211 | 🌐 Java | 📅 2026-09-02 - Official Java libraries and HBase client extensions for accessing Google Cloud Bigtable.
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 200 | 🌐 Scala | 📅 2026-09-01 - Suite of tools for working with big geo-spatial data in a distributed fashion, that can leverage Bigtable as its backend.
...
* [Apache Accumulo](https://github.com/apache/accumulo) ⭐ 1,166 | 🐛 331 | 🌐 Java | 📅 2026-09-02 - Sorted, distributed key/value store that provides robust, scalable data storage and retrieval.
