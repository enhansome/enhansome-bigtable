...
* [Go](https://github.com/googleapis/google-cloud-go/tree/master/bigtable) ⭐ 4,504 | 🐛 413 | 🌐 Go | 📅 2026-09-17 - Official implementation of the Google Cloud Bigtable Go client.
* [C#](https://github.com/googleapis/google-cloud-dotnet) ⭐ 1,094 | 🐛 15 | 🌐 C# | 📅 2026-09-17 - Official implementation of the Google Cloud Bigtable .NET client.
* [C++](https://github.com/GoogleCloudPlatform/google-cloud-cpp/tree/master/google/cloud/bigtable) ⭐ 659 | 🐛 196 | 🌐 C++ | 📅 2026-09-17 - Official implementation of the Google Cloud Bigtable C++ client.
...
* [Janusgraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,838 | 🐛 598 | 🌐 Java | 📅 2026-09-17 - Open-source, distributed graph database that can use Bigtable as its storage layer.
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,497 | 🐛 199 | 🌐 Scala | 📅 2026-09-17 - Suite of tools for working with big geo-spatial data in a distributed fashion, that can leverage Bigtable as its backend.
...
* [Apache Accumulo](https://github.com/apache/accumulo) ⭐ 1,170 | 🐛 330 | 🌐 Java | 📅 2026-09-17 - Sorted, distributed key/value store that provides robust, scalable data storage and retrieval.
