...
* [Go](https://github.com/googleapis/google-cloud-go/tree/master/bigtable) ⭐ 4,503 | 🐛 429 | 🌐 Go | 📅 2026-09-03 - Official implementation of the Google Cloud Bigtable Go client.
* [C#](https://github.com/googleapis/google-cloud-dotnet) ⭐ 1,094 | 🐛 18 | 🌐 C# | 📅 2026-09-03 - Official implementation of the Google Cloud Bigtable .NET client.
* [C++](https://github.com/GoogleCloudPlatform/google-cloud-cpp/tree/master/google/cloud/bigtable) ⭐ 660 | 🐛 201 | 🌐 C++ | 📅 2026-09-03 - Official implementation of the Google Cloud Bigtable C++ client.
* [HBase Java](https://github.com/GoogleCloudPlatform/cloud-bigtable-client) ⭐ 184 | 🐛 211 | 🌐 Java | 📅 2026-09-03 - Official Java libraries and HBase client extensions for accessing Google Cloud Bigtable.
...
* [Janusgraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,831 | 🐛 598 | 🌐 Java | 📅 2026-08-18 - Open-source, distributed graph database that can use Bigtable as its storage layer.
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 201 | 🌐 Scala | 📅 2026-09-01 - Suite of tools for working with big geo-spatial data in a distributed fashion, that can leverage Bigtable as its backend.
...
* [Apache Accumulo](https://github.com/apache/accumulo) ⭐ 1,168 | 🐛 327 | 🌐 Java | 📅 2026-09-03 - Sorted, distributed key/value store that provides robust, scalable data storage and retrieval.
